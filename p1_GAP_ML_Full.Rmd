...
**Aim**  
This script is part of Daniel Leirer's PhD.
The purpose of this script is to take preprocessed gene expression data, and train machine learning classifiers based on a provided category. In this case it was to distinguish patients and healthy controls.  
This script performs minor processing of data, feature selection and trains multiple classifiers and finally creates a weighted ensemble of all trained models.
The algorithms used to train models in this case are as follows: 

1. Support Vector Machine (linear kernal)
2. Support Vector Machine (polynomial kernal)
3. Lasso and Elastic-Net Regularized Generalized Linear Model (glmnet)
4. naive bayes (nb)
5. Neural Networks With A Principal Component Step (pcaNNet)    
6. Random Forrest (rf)

For the ensemble Gradient Boosting is used.
...
# 4. get caret list and caret stack results
...
# Step 3: Build Models and Save in output directory.
```{r Build Models}
...
# Run Meta function looping and saving everything appropriatly. 
